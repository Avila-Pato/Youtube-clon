      ...
      <MuxUploaderDrop muxUploader={UPLOADER_ID} className="group drop">
        <div slot="heading" className="flex flex-col items-center gap-6">
          <div className="flex items-center justify-center gap-2 rounded-full bg-muted h-32 w-32">
            <UploadCloudIcon className="size-10 text-muted-foreground transition-all duration-300 group-drop:active:animate-bounce" />
          </div>
          <div className="flex flex-col gap-2 text-center">
            <p className="text-sm">Drag and drop your video to upload</p>
